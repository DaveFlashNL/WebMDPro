...
export const SettingsDialog = (props: {}) => {
    ...
    const { userLang, colorTheme, pageFullHeight, pageFullWidth } = useShallowEqualSelector(state => state.appState);
    ...
    const handleLangChange = useCallback(
        event => {
            dispatch(appActions.setUserLang(event.target.value));
        },
        [dispatch]
    );
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                ...
                <SimpleField name="Language" classes={classes}>
                    <Select className={classes.wider} value={userLang} onChange={handleLangChange}>
                        <MenuItem value="syslang">System language</MenuItem>
                ...
                <Typography style={{ fontSize: 12 }}>*Please note: language selection is currently non-fucntional, it follows your system lanuage for now.</Typography>
